...
@section('title', __('flag.create'))

@section('content')
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">{{ __('flag.create') }}</div>
            <form method="POST" action="{{ route('flags.store') }}" accept-charset="UTF-8">
                ...
                <div class="card-footer">
                    <input type="submit" value="{{ __('flag.create') }}" class="btn btn-success">
                    <a href="{{ route('flags.index') }}" class="btn btn-link">{{ __('app.cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
